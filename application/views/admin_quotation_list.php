...
<div class="top-height">
    <div class="index-top"><h3 style="font-size:18px;">装修报价系统管理中心</h3>
        <p style="width:30%;float:right;line-height:30px;text-align:right;padding-right:20px;">欢迎您 quabuy<a style="margin:0 0 0 20px;" href="">退出</a></p>
    ...
    <div class="area-center center">
        ...
        <table width="92%" class="table" style="">
            ...
            <tr>
                ...
                <td><?=$item['enquiry_title']?></td>
                <td><?=$item['enquiry_content']?></td>
                <td>
                    <?php if($item['enquiry_images']): ?>
                        <?php foreach($item['enquiry_images'] as $image): ?>
                ...
                <td><?=$item['addtime']?></td>
                <td>
                    <a href="/admin/quotation_edit?qid=<?=$item['quotation_id']?>"><img src="/images/admin/icon_edit.gif" title="编辑"></a>
                    <a class="a-dele" style="margin:0 0 0 10px;" onclick="return dele('报价ID:<?=$item['quotation_id']?>');" href=""><img src="/images/admin/icon_trash.gif" title="删除"></a>
                </td>
            </tr>
            <?php endforeach; ?>
            <?php endif; ?>
...
<script type="text/javascript">
    ...
    function save_price(qid,price) {
        $.ajax({
            url: '/admin/upgrade_quotation_price_ajax/',
            type: 'POST',
            dataType: 'JSON',
            data: {
                'qid':qid,
